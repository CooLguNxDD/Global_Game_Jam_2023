...
namespace CCGKit
{
    ...
    {
        [SerializeField] protected Image activeBackground;

        [SerializeField] protected TextMeshProUGUI nameText;

        [SerializeField] protected TextMeshProUGUI numCardsText;

        [SerializeField] protected TextMeshProUGUI numSpellsText;

        [SerializeField] protected TextMeshProUGUI numCreaturesText;
