        ...
        private void DrawCard(Card card)
        {
            ...
            foreach (var property in card.properties)
            {
                ...
                else if (property is StringProperty)
                {
                    ...
                    if (stringProperty.name.Contains("Text"))
                    {
                        EditorStyles.textField.wordWrap = true;
                        stringProperty.value = EditorGUILayout.TextArea(stringProperty.value,
                            GUILayout.Width(EditorConfig.LargeTextFieldWidth),
                            GUILayout.Height(EditorConfig.RegularTextAreaHeight));
                    }
                    else
                    {
                        stringProperty.value = EditorGUILayout.TextField(stringProperty.value,
                            GUILayout.MaxWidth(EditorConfig.RegularTextFieldWidth));
                    }
                }
                GUILayout.EndHorizontal();
            }
