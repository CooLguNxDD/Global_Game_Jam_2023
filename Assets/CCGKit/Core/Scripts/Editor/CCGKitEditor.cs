...
namespace CCGKit
{
    ...
    public class CCGKitEditor : EditorWindow
    {
        ...
        private const string GameConfigPathKey = "CCGKit_GameConfigurationPath";

        [MenuItem("Tools/CCG Kit/Editor", false, 0)]
        ...
        {
            if (EditorPrefs.HasKey(GameConfigPathKey))
            {
                gameConfigPath = EditorPrefs.GetString(GameConfigPathKey);
        ...
        private void OpenGameConfiguration()
        {
            ...
            if (!string.IsNullOrEmpty(path))
            {
                ...
                ResetEditorTabs();
                selectedTabIndex = 0;
                EditorPrefs.SetString(GameConfigPathKey, gameConfigPath);
            }
        }
