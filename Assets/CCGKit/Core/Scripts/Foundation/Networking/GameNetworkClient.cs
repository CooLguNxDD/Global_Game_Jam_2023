...
namespace CCGKit
{
    ...
    public class GameNetworkClient : NetworkBehaviour
    {
        ...
        protected virtual void RegisterNetworkHandlers()
        {
            ...
            NetworkClient.RegisterHandler<BroadcastChatTextMessage>(OnReceiveChatText);
        ...
        protected virtual void UnregisterNetworkHandlers()
        {
            ...
            NetworkClient.UnregisterHandler<BroadcastChatTextMessage>();
        ...
        protected void OnReceiveChatText(BroadcastChatTextMessage msg)
        {
            foreach (var player in localPlayers)
