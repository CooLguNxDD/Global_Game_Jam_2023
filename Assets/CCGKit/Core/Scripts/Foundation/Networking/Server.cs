...
namespace CCGKit
{
    ...
    public class Server : NetworkBehaviour
    {
        ...
        public virtual void SendPlayerInfoToAllClients(PlayerInfo player)
        {
            ...
            SafeSendToClient(player, playerStateMsg);
        }
        ...
        protected virtual NetPlayerInfo GetPlayerNetworkState(PlayerInfo player)
        {
            ...
            netPlayer.currentCardInstanceId = player.currentCardInstanceId;
        ...
        protected virtual NetPlayerInfo GetOpponentNetworkState(PlayerInfo player)
        {
            ...
            netOpponent.currentCardInstanceId = player.currentCardInstanceId;
        ...
        public virtual void EndGame(PlayerInfo player, EndGameType type)
        {
            ...
            NetworkServer.SendToAll<EndGameMessage>(msg);
        }
        ...
        protected virtual void EndTurn()
        {
            ...
            // Execute the turn end actions.
            foreach (var action in GameManager.Instance.config.properties.turnEndActions)
            {
                ExecuteGameAction(action);
            }
        ...
        public virtual void SafeSendToClient<T>(PlayerInfo player, T msg) where T : struct, NetworkMessage
        {
            if (player != null && player.isConnected)
            {
                NetworkServer.SendToReadyObservers<T>(player.netId, msg);
            }
        }
