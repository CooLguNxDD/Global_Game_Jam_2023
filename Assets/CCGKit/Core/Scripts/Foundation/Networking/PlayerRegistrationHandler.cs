...
namespace CCGKit
{
    ...
    public class PlayerRegistrationHandler : ServerHandler
    {
        ...
        public override void RegisterNetworkHandlers()
        {
            ...
            NetworkServer.RegisterHandler<RegisterPlayerMessage>(OnRegisterPlayer);
        }

        public override void UnregisterNetworkHandlers()
        {
            base.UnregisterNetworkHandlers();
            NetworkServer.UnregisterHandler<RegisterPlayerMessage>();
        }

        protected virtual void OnRegisterPlayer(NetworkConnection conn, RegisterPlayerMessage msg)
        {
