...
namespace CCGKit
{
    ...
    public class IntFieldAttribute : FieldAttribute
    {
        ...
        public IntFieldAttribute(string prefix) : base(prefix)
        {
        }
        ...
        public override void Draw(GameConfiguration gameConfig, object instance, ref FieldInfo field)
        {
            ...
            field.SetValue(instance, EditorGUILayout.IntField((int)field.GetValue(instance), GUILayout.MaxWidth(width)));
        }
